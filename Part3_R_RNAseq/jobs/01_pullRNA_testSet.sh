...
#SBATCH -J fqtx
#SBATCH -o /uufs/chpc.utah.edu/common/home/u0210816/Teaching/BioinfWorkshop/Part3_R_RNAseq/jobs/transfer_TestSet.outerror
#SBATCH -A round-np
...
#fastq-dump --split-3 ${line}.sra
#rm ${line}.sra
#done < ${WRKDIR}/metadata/SRR_Acc_List_RNASeq.txt
#cd ../
...
cd /scratch/general/lustre/u0210816/Part3_R_RNAseq/TestSet
mkdir -p /uufs/chpc.utah.edu/common/home/round-group2/BioinfWorkshop2021/Part3_R_RNAseq/TestSet/
mv *.gz /uufs/chpc.utah.edu/common/home/round-group2/BioinfWorkshop2021/Part3_R_RNAseq/TestSet/
