...
```
2. Download and install miniconda3 using their shell script, then remove the install script when it's finished. (add the `-u` option if prompted that conda already exists)
```bash
