...
`/uufs/chpc.utah.edu/common/home/round-group2/BioinfWorkshop2021/Part3_R_RNAseq/metadata/SraRunTable_RNAseq_BiopsyOnly.txt`

## Objectives:
##### I. Finish intro to data frames from previous class
##### II. Introduce data wranging with tidyverse functions.
##### III. Create metadata tables with full alignment file paths.
...
The readr function should look like this (you **don't** need to enter this, but in practice you should copy it to your markdown so you can document it)(one command over multiple lines shown here):
```r
metadata <- read_delim(
